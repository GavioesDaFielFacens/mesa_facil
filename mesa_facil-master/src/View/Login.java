...
public class Login extends javax.swing.JFrame {
    String senha;
    Cadastro CadastroC = new Cadastro();
    ...
    public void Autenticar(Cliente cliente){
        ...
        String p = new String(txtSenha_log.getPassword());
        
        try{
            this.conectar.executarSQL("select * from Usuario where nome = '" + txtNome_log.getText() + "';");
            while(this.conectar.getResultSet().next()){
                senha = (this.conectar.getResultSet().getString(3));
            }
            if (senha.equals(p)){
                JOptionPane.showMessageDialog(null, "Usuario encontrado, bem vindo " + txtNome_log.getText());
